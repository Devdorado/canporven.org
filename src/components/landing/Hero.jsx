...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden" aria-labelledby="hero-heading">
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-20 md:py-32 flex justify-center">
        ...
        >
          ...
          <h1
            id="hero-heading"
            className="text-3xl md:text-5xl font-bold text-white leading-tight mb-4 drop-shadow-lg"
          >
            {t('hero.headline', lang)}
          </h1>

          <p className="text-lg md:text-xl text-white max-w-2xl mx-auto mb-3 leading-relaxed drop-shadow">
            {t('hero.subheadline', lang)}
          </p>

          <p className="text-base md:text-lg text-white/90 max-w-xl mx-auto mb-10 leading-relaxed drop-shadow">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="#aviso"
              className="inline-flex items-center justify-center px-8 py-4 bg-white/10 text-white font-semibold text-base rounded-lg border-2 border-white/50 hover:border-white hover:bg-white/20 transition-colors min-h-[48px] backdrop-blur-sm"
            >
